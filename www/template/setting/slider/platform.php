...
$platform_filename = config_get_value_from_file('/mnt/config/noc.conf','filename');
?>
...
<input type="radio" name="authmode" value="0"  style="margin: 0;border: none!important;box-shadow: none!important;margin-right: 6px;"
<?php
		if ($platform_authmode=="0") {
		?>	
		checked='true' 
		<?php
		}
		?>/> <?php echo $L['platform_typea'];?>
<input type="radio" name="authmode" value="1"  style="margin: 0;margin-left:22px;border: none!important;box-shadow: none!important;margin-right: 6px;"
<?php
	...
	<div class="box_line platform_typea <?php echo $platform_authmode=="1"?"hidden":"";?>" style="margin-bottom: 8px;">
		<span class='infotitle'><?php echo $L['platform_id'];?>:</span><input type="text" id="id"  
    value="<?php echo $platform_id;?>" />
	</div>
	<div class="box_line platform_typea <?php echo $platform_authmode=="1"?"hidden":"";?>">
		<span class='infotitle'><?php echo $L['platform_password'];?>:</span><input type="text" id="password" 
    value="<?php echo $platform_password;?>" />
	</div>
    <div class="box_line platform_typeb <?php echo $platform_authmode=="1"?"":"hidden";?>">
