...
<head>
	...
	<title><?php echo $L['ui_desktop'].' - '.$L['secros_name'].$L['secros_power_by'];?></title>
	...
	<link href="<?php echo STATIC_PATH;?>style/skin/<?php echo $config['user']['theme'];?>app_desktop.css?ver=<?php echo SECROS_VERSION;?>" rel="stylesheet" id='link_css_list'/>
...
<body style="overflow: hidden;" oncontextmenu="return core.contextmenu();">
	...
	<div id="menuwin">
		...
		<ul id="programs">
			<li><a href="#" onclick="ui.pathOpen.openIE('http://www.secros.com','<?php echo $L['my_document'];?>');">secrosexplorer-home</a></li>
			<li><div id="leftspliter"></div></li>
			<li><a href="#" onclick="core.setting('help');">secrosexplorer-<?php echo $L['setting_help'];?></a></li>
			<li><a href="#" onclick="core.setting('about');">secrosexplorer-<?php echo $L['setting_about'];?></a></li>
			<li><a href="#" onclick="core.setting('user');">secrosexplorer-<?php echo $L['setting'];?></a></li>
			<li class="search"></li>
		</ul>
		<ul id="links">
			<li class="icon"></li>
