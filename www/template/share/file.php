...
<head>
	...
	<title><?php echo $share_info['name'].' - '.$L['share_title'].' - '.$L['secros_name'].$L['secros_power_by'];?></title>
	<link rel="Shortcut Icon" href="<?php echo STATIC_PATH;?>images/favicon.ico">
	<link href="<?php echo STATIC_PATH;?>style/bootstrap.css?ver=<?php echo SECROS_VERSION;?>" rel="stylesheet"/><link rel="stylesheet" href="./static/style/font-awesome/css/font-awesome.css">
	...
	<link href="<?php echo STATIC_PATH;?>style/skin/<?php echo $config_theme;?>app_code_edit.css?ver=<?php echo SECROS_VERSION;?>" rel="stylesheet" id='link_css_list'/>
...
<script src="<?php echo STATIC_PATH;?>js/lib/ace/src-min-noconflict/ace.js?ver=<?php echo SECROS_VERSION;?>"></script>
<script src="<?php echo STATIC_PATH;?>js/lib/ace/src-min-noconflict/ext-static_highlight.js?ver=<?php echo SECROS_VERSION;?>"></script>
