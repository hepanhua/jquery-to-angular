...
<head>
	...
	<title>tips - <?php echo $L['share_title'].' - '.$L['secros_name'].$L['secros_power_by'];?></title>
	...
	<link href="<?php echo STATIC_PATH;?>style/skin/simple/app_code_edit.css?ver=<?php echo SECROS_VERSION;?>" rel="stylesheet" id='link_css_list'/>
