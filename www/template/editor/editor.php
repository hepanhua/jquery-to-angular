...
<head>
	...
	<title><?php echo $L['ui_editor'].' - '.$L['secros_name'].$L['secros_power_by'];?></title>
	...
	<link href="<?php echo STATIC_PATH;?>style/skin/<?php echo $config['user']['theme'];?>app_editor.css?ver=<?php echo SECROS_VERSION;?>" rel="stylesheet" id='link_css_list'/>
