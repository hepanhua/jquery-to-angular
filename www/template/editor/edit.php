...
<meta name="author" content="secros.">
  <head>
  	<title><?php echo $L['secros_name'].$L['secros_power_by'];?></title>
	...
	<link href="<?php echo STATIC_PATH;?>style/skin/<?php echo $config['user']['theme'];?>app_code_edit.css?ver=<?php echo SECROS_VERSION;?>" rel="stylesheet" id='link_css_list'/>
