...
define(function(require, exports) {
	...
	var readmore_href  = 'http://www.secros.com/usbox/download.html';
	var current_version_file = 'http://www.secros.com/usbox/download/update/2.0-'+server_version+'.zip';
	var status_href = 'http://www.secros.com/usbox/state/index.php';
	
	var secros_user_online = 'secros_user_online_version';
	...
	var check_version = function(display){
		var ver_new = parseFloat(server_version),
			...
			key_timeout = 'secros_update_ignore_timeout',
			has_new = false;
