...
define('Pic_View',0);    //图片缩略图
/*
 可以自定义【用户目录】和【公共目录】;移到web目录之外，
 可以使程序更安全, 就不用限制用户的扩展名权限了;
 */
define('CONFIG_PATH', '/mnt/config/');        //配置目录
define('USER_PATH',     CONFIG_PATH .'User/');        //用户目录
//自定义用户目䧧'''½；需要先将data/User移到别的地方 再修改配置，例如：
//define('USER_PATH',  /mnt/usbox/User');
